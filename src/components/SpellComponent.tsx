...
export default class SpellComponent extends React.PureComponent<SpellComponentProps, SpellComponentState> {
    ...
    render() {
        return <div
            ...
            + (this.props.isBig ? " big" : "") + (this.props.isOpacity ? " opacity-50" : "")}
            style={
                {
            ...
            <strong className="text-center d-block"><FontAwesomeIcon
            ...
            <span className="position-absolute bottom-0 start-0 p-2">D: {this.props.spell.duration}</span>
            <span className="position-absolute bottom-0 end-0 p-2">PO: {this.props.spell.radius}</span>
